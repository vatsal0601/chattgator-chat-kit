...
const ComboBox: React.FC<Props> = ({ selected, setSelected, peopleOptions, className = {} }) => {
		...
		<div className={`${className}`}>
			...
			>
				<div className="relative">
					<div className="relative w-full cursor-default overflow-hidden rounded-lg bg-white text-left shadow-md focus:outline-none text-xs lg:text-sm">
						<Combobox.Input
							className="w-full border-none focus:outline-none py-2 pl-3 pr-10 text-sm leading-5 text-gray-900 focus:ring-0"
							displayValue={(person: UserResponse) => person.name}
